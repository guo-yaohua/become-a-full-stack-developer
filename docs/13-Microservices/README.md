...
- [十三、微服务](#十三微服务)
  ...
  - [10 JWT](#10-jwt)
    ...
    - [10.5 使用](#105-使用)
  - [11 RocketMQ](#11-rocketmq)
    - [11.1 消息中间件](#111-消息中间件)
    - [11.2 功能](#112-功能)
      - [11.2.1 异步化](#1121-异步化)
      - [11.2.2 限流削峰](#1122-限流削峰)
      - [11.2.3 对比](#1123-对比)
    - [11.3 模型](#113-模型)
      - [11.3.1 相关概念](#1131-相关概念)
      - [11.3.2 概念模型](#1132-概念模型)
      - [11.3.3 部署模型](#1133-部署模型)
      - [11.3.4 注意事项](#1134-注意事项)
    - [11.4 下载使用](#114-下载使用)
      - [11.4.1 下载](#1141-下载)
      - [11.4.2 启动](#1142-启动)
    - [11.5 整合](#115-整合)
...
> AMQP: 即 Advanced Message Queuing Protocol，⼀个提供统⼀消息服务的应⽤层标准⾼级消息队列协议，是应⽤层协议的⼀个开放标准，为⾯向消息的中间件设计。
